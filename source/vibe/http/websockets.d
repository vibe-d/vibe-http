	...
	*/
	...
	nothrow {
		try {
			...
			logException(e, "Failed to wait for WebSocket initialization");
		}

		try m_conn.close();
		catch (Exception e) logException(e, "Failed to close connection after handling WebSocket connection");
